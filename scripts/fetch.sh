...
REPOS="poky metaoe metaselinux metavirtualization"
...
METAVIRTUALIZATION_URI="git://git.yoctoproject.org/meta-virtualization.git"
METAVIRTUALIZATION_PATH="poky/meta-virtualization"
METAVIRTUALIZATION_REV="${METAVIRTUALIZATION_REV-refs/remotes/origin/${branch}}"

METAVIRTUALIZATIONTEST_URI="."
METAVIRTUALIZATIONTEST_PATH="poky/meta-virtualization-test"
...
rm -rf "${METAVIRTUALIZATIONTEST_PATH}" || die "unable to clear old ${METAVIRTUALIZATIONTEST_PATH}"
ln -sf "../${METAVIRTUALIZATIONTEST_URI}" "${METAVIRTUALIZATIONTEST_PATH}" || \
	die "unable to symlink ${METAVIRTUALIZATIONTEST_PATH}"
